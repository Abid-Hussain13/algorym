...
const buttonVariants = cva(
  'inline-flex items-center justify-center gap-[9px] rounded-sm border font-body text-sm font-semibold tracking-[0.02em] transition-all duration-1 ease-default cursor-pointer',
  {
    variants: {
      variant: {
        primary:
