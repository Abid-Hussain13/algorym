...
export function Hero() {
  return (
    <header className="relative mx-auto flex max-w-[1200px] items-center justify-between gap-10 px-10 pt-[60px] pb-[88px] max-[1024px]:flex-col max-[1024px]:justify-center max-[1024px]:gap-8 max-[1024px]:px-7 max-[1024px]:pb-12 max-[1024px]:pt-12 max-[480px]:px-5 max-[480px]:pb-10 max-[480px]:pt-10">
